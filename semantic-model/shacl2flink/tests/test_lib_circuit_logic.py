...
INSERT INTO constraint_table VALUES
    ( 1, NULL,  0, 'Cutter', 'warning'),
    ( 2, NULL,  0, 'Cutter', 'warning'),
    ( 3, NULL,  0, 'Cutter', 'warning'),
    (10, 'AND', 1, 'Cutter', 'critical'),
    (11, 'NOT', 1, 'Cutter', 'critical'),
    (12, 'XONE',1, 'Cutter', 'critical'),
    (13, 'OR',  1, 'Cutter', 'critical');
...
INSERT INTO constraint_table VALUES
    ...
    ( 2, NULL,  0, 'Cutter', 'warning'),
    ( 3, NULL,  0, 'Cutter', 'warning'),
    (10, 'AND', 1, 'Cutter', 'warning'),
    (11, 'NOT', 1, 'Cutter', 'warning'),
    (20, 'AND', 2, 'Cutter', 'critical');
